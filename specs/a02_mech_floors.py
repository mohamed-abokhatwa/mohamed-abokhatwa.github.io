...
<div class="fig">
  <div class="fig-head">
    ...
    <div class="fsub">Q = n·A·q. Riser area = 1.8·Q/v, counting supply and return together. The blue line is the same building served by floor-by-floor air handling, where only outdoor air rides the riser.</div>
  </div>
...
<div class="fig">
  <div class="fig-head">
    ...
    <div class="fsub">Zone height = allowable pressure / 0.0981 bar·m⁻¹. Domestic water is shown two ways: zoned on the fixture comfort window alone, and zoned on riser pipe class with floor PRVs doing the fine control.</div>
  </div>
