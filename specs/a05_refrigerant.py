...
<div class="fig">
  ...
  <div class="readout">
    <div class="cell"><div class="k">Static pressure lost</div><div class="v" id="rDp">5.6 <small>bar</small></div></div>
    <div class="cell"><div class="k">Sub-cooling needed</div><div class="v" id="rSc">10.3 <small>K</small></div></div>
    <div class="cell"><div class="k">Max lift available</div><div class="v" id="rMx">77 <small>m</small></div></div>
    <div class="cell"><div class="k">Margin</div><div class="v" id="rMg">1.7 <small>K</small></div></div>
    <div class="cell"><div class="k">Verdict</div><div class="v" style="font-size:15px;margin-top:6px;"><span id="rVd"></span></div></div>
  </div>
</div>
<p class="fig-note">At the default R-410A properties, a <strong>60&nbsp;m lift costs 5.6&nbsp;bar and 10.3&nbsp;K of sub-cooling</strong> against 12&nbsp;K available — a margin of only 1.7&nbsp;K before the liquid line starts producing flash gas, and that is before line friction and a hot riser shaft are counted. The limit is about <strong>77&nbsp;m</strong>. Switch to R-134a with its shallower saturation slope and heavier liquid and the picture changes completely, which is exactly why centrifugal chillers with R-134a and a water distribution system remain the default for tall buildings while DX stays a zone-by-zone solution.</p>
...
<div class="fig">
  ...
  <div class="readout">
    ...
    <div class="cell"><div class="k">Round duct</div><div class="v" id="rDd">450 <small>mm</small></div></div>
  </div>
</div>
