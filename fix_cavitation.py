...
def write_article(filename, title, tag, date, read_time, img_src, img_alt, body):
    if filename != "cavitation-prvs-fcvs-new.html":
        return  # Only generate the cavitation article
    html = """<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
write_article(
    "sustainable-pump-selection.html",
