...
SPEC = dict(
    ...
    og_desc='Greywater is about twice the volume WC flushing can absorb, so a flush-only scheme discards half its source — while a 50 MW cooling plant next door drinks 1,800 m3 a day the same greywater covers only 13 percent of.',
