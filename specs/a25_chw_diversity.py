...
<ul class="clean">
  <li><strong>An hourly block load report</strong>, to ASHRAE Standard 183 and the load chapter of the Fundamentals handbook, as ASHRAE 90.1 &sect;6.4.2.1 and, in Saudi Arabia, SBC&nbsp;501 &sect;312.1 require for system sizing [2, 3, 9, 15]. It must give the peak and its hour for every zone, floor, use, riser, hydraulic zone, heat exchanger and the plant. Coincident peaks, not sums.</li>
...
<ol class="refs">
  ...
  <li>Wilkins, C.K. and Hosni, M.H. &ldquo;Plug Load Design Factors.&rdquo; <em>ASHRAE Journal</em> 53(5), May 2011, pp.&nbsp;30&ndash;34: measured diversity of office equipment and design plug-load factors.</li>
  <li>Saudi Building Code SBC&nbsp;501 (<em>Mechanical</em>), &sect;312.1: system design loads to be determined to ASHRAE/ACCA Standard 183 or an approved equivalent procedure.</li>
</ol>
"""
