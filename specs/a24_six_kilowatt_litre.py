...
<div class="fig">
  ...
  <div class="controls">
    ...
    <div class="ctrl">
      ...
      <div class="hint">Pressure exchanger effectiveness. Drag to zero to see what this same plant would cost without recovery; the 1990s figure of about ten also carried a lower recovery ratio and worse pumps.</div>
    </div>
    <div class="ctrl">
