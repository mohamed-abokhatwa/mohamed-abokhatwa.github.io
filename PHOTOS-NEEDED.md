# Hero images still needed — megatall MEP series

Each article below is **published and live** but its hero image is a 404 until you supply it.
Generate each in Gemini with the prompt given, then send them to me in one batch and I will
clean any watermark, compress to WebP, build the 320×200 thumb and the 1200×630 OG image,
and push.

**File naming** — if you can name them, use the `slug` below (e.g. `domestic-water-tall-buildings.png`).
If not, just send them in order and I will match them.

**House style for every prompt** (already embedded below): 16:9, dark slate / deep navy
background, precise technical cutaway rendering, thin crisp linework, two accent colours only,
and **absolutely no text, letters, numbers, labels, logos or watermarks**.

---

## 1 · domestic-water-tall-buildings

```text
A highly detailed technical cross-section illustration of a supertall skyscraper, cut open
vertically to reveal its potable water system. Show a stack of four distinct vertical pressure
zones, each separated by a break tank and a booster pump set on a mechanical floor, with a
luminous cool blue supply riser running up through them. At every residential floor, show a
small pressure-reducing valve on the branch where it leaves the riser, so the eye reads
"one riser, many small pressure controls". At the base, show a large storage tank room with
transfer pumps.

Render the water path as a glowing pale blue line with clear upward flow. Make the four zone
break points visually distinct and bright, as the structural rhythm of the image.

Style: precise architectural and mechanical engineering cutaway, cinematic lighting, dark slate
and deep navy background, cool blue and warm amber as the only accent colours, thin crisp
linework, high contrast, scientific rather than decorative.

Aspect ratio 16:9, wide landscape, full tower visible top to bottom with generous headroom.
Absolutely no text, no letters, no numbers, no labels, no logos, no watermarks.
```

---

## 2 · mechanical-floors-tall-buildings

```text
A highly detailed technical cross-section illustration of a supertall skyscraper, cut open
vertically. The subject is the MECHANICAL FLOORS: show four double-height plant levels spaced
evenly up the tower, each one densely packed with air-handling units, chillers, pumps, tanks and
heat exchangers, glowing warmly from within against the darker, sparser office floors above and
below them.

Between the mechanical floors, show the vertical riser shafts as bright slender channels running
through the core, visibly thicker where they serve more floors and stepping down in size after
each mechanical level.

Style: precise architectural and mechanical engineering cutaway, cinematic lighting, dark slate
and deep navy background, warm amber for the plant levels and cool blue for the risers as the
only accent colours, thin crisp linework, high contrast.
...
## 3 · outdoor-air-ventilation-tall-buildings

```text
A highly detailed technical cross-section illustration of a supertall skyscraper showing its
FRESH AIR system, with strong wind acting on it. On the windward face, show dense luminous
streamlines of outside air striking the tower and being forced into a large intake louvre on a
mechanical floor; on the leeward face show the airflow separating and curling away in a low
pressure wake, with a relief louvre there.

Inside the mechanical floor, show an air-handling plant in cutaway: a bank of filters, a large
rotating energy recovery wheel, and a coil, with the treated air rising away up a slender
vertical riser into the floors above.

Render the wind as cool blue-white streamlines and the exhaust air as warm amber.

Style: precise architectural and mechanical engineering cutaway, cinematic lighting, dark slate
and deep navy background, cool blue and warm amber as the only accent colours, thin crisp
linework, high contrast.

Aspect ratio 16:9, wide landscape, full tower visible with generous headroom.
Absolutely no text, no letters, no numbers, no labels, no logos, no watermarks.
```

---

## 4 · cooling-towers-heat-rejection-tall-buildings

```text
A highly detailed technical cross-section illustration of the upper portion of a supertall
skyscraper, cut open to show its HEAT REJECTION plant. On an open plant deck near the top, show
a bank of large cooling towers with their fans, and a warm plume of moist air rising from them
and being bent sideways by the wind. Immediately on the mechanical floor below the towers, show
large centrifugal chillers, connected upward to the tower basins by two heavy vertical condenser
water pipes — one cool blue rising, one warm amber returning.

Emphasise that the chillers sit directly beneath their towers, with a short heavy pipe
connection, not a long run down the building.

Style: precise architectural and mechanical engineering cutaway, cinematic lighting, dark slate
and deep navy background, cool blue and warm amber as the only accent colours, thin crisp
linework, high contrast.

Aspect ratio 16:9, wide landscape composition. Absolutely no text, no letters, no numbers, no
labels, no logos, no watermarks.
```

---

## 5 · refrigerant-systems-tall-buildings

```text
A highly detailed technical cross-section illustration of a section of a supertall skyscraper
showing a REFRIGERANT system. Show a condensing plant sitting on a mechanical floor at the TOP
of the zone, with a fine bright liquid refrigerant line descending from it to the floors below,
and a thicker suction line rising back up to it — making it visually obvious that the liquid
falls rather than climbs.

On the rising suction line, show a distinct U-shaped oil trap at the base and at intervals up its
length. In a separate enclosed plant room at the bottom of the frame, show a compact refrigerating
machinery room with a large exhaust duct leaving it.

Render the liquid line as a fine cool blue line and the suction line as a thicker pale amber one.

Style: precise mechanical engineering cutaway, cinematic lighting, dark slate and deep navy
background, cool blue and warm amber as the only accent colours, thin crisp linework.

Aspect ratio 16:9, wide landscape. Absolutely no text, no letters, no numbers, no labels, no
logos, no watermarks.
```

---

## 6 · vertical-transportation-mep-tall-buildings

```text
A highly detailed technical cross-section illustration of a supertall skyscraper's LIFT CORE, cut
open vertically. Show a tall hoistway with a lift car travelling upward at speed in it, and render
the air being displaced around the car as luminous streamlines squeezing through the narrow gap
between the car and the shaft wall, compressed and bright above the car and rarefied below it.

At the top of the shaft show the machine room in cutaway, containing large drive machines and a
compact cooling unit, glowing warm to signal heat. Along the shaft, show slender pressurisation
ducts injecting air into the hoistway at three separate levels.

Render the displaced air as cool blue-white streamlines and the machine room heat as warm amber.

Style: precise architectural and mechanical engineering cutaway, cinematic lighting, dark slate
and deep navy background, cool blue and warm amber as the only accent colours, thin crisp
linework, high contrast.

Aspect ratio 16:9, wide landscape, full shaft visible top to bottom.
Absolutely no text, no letters, no numbers, no labels, no logos, no watermarks.
```

---

## 7 · vibration-noise-control-tall-buildings

```text
A highly detailed technical cutaway illustration of a single MECHANICAL FLOOR inside a supertall
skyscraper, seen in section, with an occupied office floor visible above it and a residential
floor below it. On the plant floor show large pumps and an air-handling unit mounted on thick
concrete inertia bases, each base sitting on tall visible steel coil spring isolators with a
clear air gap beneath the base.

Show the pipes and ducts leaving the plant on visible resilient spring hangers, and render faint
concentric ripples of vibration radiating from one machine into the slab, fading as they pass the
isolators — so the image reads as vibration being stopped.

Style: precise mechanical engineering cutaway, cinematic lighting, dark slate and deep navy
background, cool blue for the structure and warm amber for the machinery as the only accent
colours, thin crisp linework, high contrast.
