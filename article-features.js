...
(function () {
  ...
  var ARTICLES = [
    ...
    { url:'one-way-surge-tank-design.html', title:'One-Way Surge Tanks at the Knee: Cutting the Surge Vessel by Nearly Two-Thirds', cat:'surge', thumb:'one-way-surge-tank-design.webp', mins:33, tag:'Surge Analysis · One-Way Surge Tank · Pipeline Profile' },
    { url:'surge-relief-valve-sizing.html', title:'Surge Relief Valve Sizing: What a Valve at the Pump Can and Cannot Protect', cat:'surge', thumb:'surge-relief-valve-sizing.webp', mins:32, tag:'Surge Analysis · Surge Relief Valve · Pump Stations' },
    { url:'pump-inertia-flywheel-surge.html', title:'Pump Inertia and the Flywheel: When Spinning Mass Can Replace a Surge Vessel', cat:'surge', thumb:'pump-inertia-flywheel-surge.webp', mins:33, tag:'Surge Analysis · Pump Inertia · Flywheel' },
    { url:'choosing-surge-protection.html', title:'Choosing Surge Protection: Vessel, One-Way Tank, Relief Valve or Flywheel on the Same Pipeline', cat:'surge', thumb:'choosing-surge-protection.webp', mins:36, tag:'Surge Analysis · Surge Protection · Design Decisions' },
    { url:'six-kilowatt-litre-water-energy-tall-buildings.html', title:'The Six-Kilowatt Litre: What Water Really Costs by the Time It Reaches the Top of a Gulf Tower', cat:'desalination', thumb:'six-kilowatt-litre-water-energy-tall-buildings.webp', mins:18, tag:'Desalination · Water-Energy Nexus · Tall Buildings' },
    ...
    { url:'surge-scenarios-pump-stations.html',    title:'Surge Scenarios in Pumping Stations — and Which One Governs the Design',                                 cat:'surge',       thumb:'surge-scenarios-pump-stations.webp',   mins:11, tag:'Hydraulic Transients · Surge Analysis' },
    { url:'hammer-transient-simulation-workflow.html', title:'Computing a Transient Simulation in Bentley HAMMER: A Step-by-Step Workflow',                           cat:'surge',       thumb:'hammer-transient-simulation-workflow.webp', mins:9, tag:'Transient Analysis · Bentley HAMMER' },
    ...
    { url:'surge-vessel.html',                     title:'Sizing the Hydropneumatic Surge Vessel in Water Transmission Pipelines',                                  cat:'surge',       thumb:'surge-vessel.webp',                    mins:37, tag:'Surge Analysis · Hydraulic Design' },
    ...
    { url:'pre-charge-pressure.html',              title:'The Pre-Charge Pressure of the Surge Vessel — How One Number Changes Everything',                         cat:'surge',       thumb:'IMG_4656.webp',                        mins:41, tag:'Surge Analysis · Surge Vessel Design' },
  ...
  function injectCSS() {
    ...
    style.textContent = [
      ...
      '  background:color-mix(in srgb, #005f92 10%, transparent);',
      '  font-size:13px;',
      '  font-weight:600;',
      '  color:#005f92;',
      '  cursor:pointer;',
      ...
      '  background:var(--bg-primary,var(--text-primary));',
      ...
      '}',
      '.inline-cta-icon{ color:var(--accent,var(--accent)); flex-shrink:0; display:flex; align-items:center; }',
      ...
      '}',
      '.inline-cta-btn:hover{ background:var(--accent); }',
      ...
      '}',
      '@media(min-width:1440px){ .ar-rail{ display:block; } }',
      ...
      '@media(min-width:1440px){ html.has-ar-rail #read-progress-bar{ display:none; } }',
      '@media(min-width:1440px){ html.has-ar-rail #article-toc-mobile{ display:none; } }',
